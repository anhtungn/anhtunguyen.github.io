...
const EmailSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="z-10">
        <h5 className="text-transparent font-bold bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 text-xl lg:text-3xl">
          Let&apos;s Connect
        </h5>
        <p className="text-black mb-4 max-w-md text-40">
          {" "}
